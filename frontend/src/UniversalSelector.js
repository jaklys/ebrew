      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          {recipes.map((recipe, index) => (
            <div
              key={index}
              className="relative p-4 border rounded-lg hover:border-blue-500
            ...
            >
              ...
              {activeMenu === index && (
                <div
                  ref={menuRef}
                  className="absolute right-0 top-full mt-1 bg-white shadow-lg rounded-lg
                             border z-10"
                >
                  <div className="p-1">
                    <button
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 w-full p-2 text-left text-red-500 rounded
                                 hover:bg-red-50"
                    >
                      <Trash2 size={16} />
                      <span>Smazat</span>
